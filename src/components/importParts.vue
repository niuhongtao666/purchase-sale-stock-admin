        ...
        <div class="content">
          ...
          <div class="row">
            ...
            <div class="right rightDown" style="font-weight: 400">
              <a :href='downUrl+module[importType]+".xls"' style="color:#00BAFF;">下载导入模版</a>
  ...
  export default {
    ...
    data(){
      return{
        ...
        buttonShow:false,
        module:{
          saleOrderImportGoods:'销售单导入配件模版',
          stockDeliverImportGoods:'发料单导入配件模版',
          purchaseApplyImportGoods:'采购申请单导入配件模版',
          purchaseOrderImportGoods:'采购单导入配件模版',
          allotOrderImportGoods:'调拨单导入配件模版',
          innerReceiveImportGoods:'内领出库单导入配件模版',
          stockProfitImportGoods:'盘点调整单导入模版',
          warehouseType:'库位导入模版'
    ...
    methods:{
      ...
      submitUpload(content) {
        ...
        var _this=this;
        this.$axios.post('/admin/excel/import/'+this.importType,formData).then(res=>{
