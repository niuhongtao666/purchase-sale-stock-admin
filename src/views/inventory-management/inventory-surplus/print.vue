            ...
            <div class="tableZonePrint">
              <div class="ulPrint" id="ulPrint">
                ...
                <div class="extraInfo" style="line-height:40px;font-size: 14px;display: flex;">
                  <div class="application" style=" text-align: left;flex: 3;">入库单号：{{data.checkInputOrderNo}}</div>
                  <div class="store" style="text-align: left;flex: 2;text-indent: -33px;">盘点单号：{{data.checkOrderNo}}</div>
                  <div class="person" style="flex: 2;text-align: right;">入库日期：{{data.createTime}}</div>
                </div>
                ...
                <div class="tableZone printTable" >
                 <table class="table" cellspacing="0" border  frame=hsides>
                    ...
                    <tr style="text-align: center;height: 55px">
                      ...
                      <th style="min-width:100px">厂家编号</th>
                      <th style="min-width:100px">商品类别</th>
                      <th style="min-width:70px">入库数量</th>
                      <th style="min-width:70px">成本单价</th>
                      <th style="min-width:70px">成本金额</th>
                      <th style="min-width:70px">结存数量</th>
                      <th style="min-width:80px">库位号</th>
                    </tr>
                    </thead>
                    <tbody>
                ...
                <div class="extraInfo" style="line-height:40px;font-size: 14px;display: flex;">
                  <div class="application" style=" text-indent: 97px;flex: 1;">收料员：</div>
                  <div class="store" style="text-indent: 355px;flex: 1;">开单员：</div>
                </div>
              </div>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    computed:{
      allData(){
        return this.data.checkInputOrderDetailList;
      },
    },
    props:{
      // 针对分页表格模式：传入的打印数据。
