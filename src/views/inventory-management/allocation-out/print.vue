            ...
            <div class="tableZonePrint">
              <div class="ulPrint" id="ulPrint">
                ...
                <div class="extraInfo" style="line-height:40px;font-size: 14px;display: flex;">
                  <div class="application" style=" text-align: left;flex: 3;">出库单号：{{data.allotOutputOrderNo}}</div>
                  <div class="store" style="text-align: left;flex: 2;text-indent: -33px;">出库门店：{{data.allotOutStoreName}}</div>
                  <div class="person" style="flex: 2;text-align: right;">出库日期：{{data.createTime}}</div>
                </div>
                ...
                <div class="tableZone printTable" >
                 <table class="table" cellspacing="0" border  frame=hsides>
                    ...
                    <tr style="text-align: center;height: 55px">
                      ...
                      <th style="min-width:70px">出库数量</th>
                      <th style="min-width:70px">调拨价</th>
                      <th style="min-width:70px">总价</th>
                    ...
                    <tr v-for="(data,index) in allData" :key="index" style="text-align: center;height: 45px;">
                      ...
                      <td>{{data.allotNum}}</td>
                      <td>{{data.allotPrice}}</td>
                      <td>{{data.allotTotalPrice | decimalTofixed2}}</td>
