            ...
            <div class="tableZonePrint">
              <div class="ulPrint" id="ulPrint">
                ...
                <div class="extraInfo" style="line-height:40px;font-size: 14px;display: flex;">
                  <div class="application" style=" text-align: left;flex: 3;">退货单号：{{data.purchaseReturnInfo.purchaseReturnNo}}</div>
                  <div class="store" style="text-align: left;flex: 2;text-indent: -33px;">退货门店：{{data.purchaseReturnInfo.storeName}}</div>
                  <div class="person" style="flex: 2;text-align: right;">退货人：{{data.purchaseReturnInfo.createUserName}}</div>
                </div>
                <div class="extraInfo" style="line-height:40px;font-size: 14px;display: flex;">
                  <div class="application" style=" text-align: left;flex: 3;">采购单号：{{data.purchaseReturnInfo.purchaseOrderNo}}</div>
                  <div class="store" style="text-align: left;flex: 2;text-indent: -33px;">供应商：{{data.purchaseReturnInfo.supplierName}}</div>
                  <div class="person" style="flex: 2;text-align: right;visibility: hidden"></div>
                </div>
                ...
                <div class="tableZone printTable" >
                 <table class="table" cellspacing="0" border  frame=hsides>
                    ...
                    <tr style="text-align: center;height: 55px">
                      ...
                      <th style="min-width:70px">退货数量</th>
                      <th style="min-width:70px">退货单价</th>
                      <th style="min-width:70px">退货总价</th>
                      <th style="min-width:80px">仓库</th>
                      <th style="min-width:80px">库位</th>
                    </tr>
                    </thead>
                    <tbody>
