  ...
  <div>
    <div v-for="page in pages" :key="page">
      ...
      <div class='tab_company_out'>
        <h3>你的公司名字有限公司</h3>
        <div class='dan' style="display:none;">进货单
        ...
        <table cellpadding='0' cellspacing='0'  border="1">
          ...
          <tr v-if="page==pages" style="display: none">
            <td colspan='2'>合计</td>
        ...
        <ul class='lu' style="display: none">
          <li>发货人：
...
<style scoped>
  * {
  ...
  .tab_company_out p span {
    float: left;
  }

  .tab_company_out p span ins {
    text-decoration: underline;
  }

  .tab_company_out p time {
    float: right;
  }

  .tab_company_out table {
    width: 100%;
    margin: 0 auto;
    border: none;
  ...
  .tab_company_out table tr td:last-of-type,
  .tab_company_out table tr th:last-of-type {
    border-right: 1px solid #000;
  }

  .tab_company_out table tr th {
  ...
  .tab_company_out table tr th:nth-child(2) {
    /*width: 0;*/
  }
  ...
  .tab_company_out .lu li {
    float: left;
    text-align: left;
    margin-right: 15px;
  }

  .tab_company_out .lu li label {
    width: 100px;
    display: inline-block;
  }

  .tab_company_out .lu li:last-of-type {
    margin-right: 0;
  }
  @media print {
    .tab_company_out table {
