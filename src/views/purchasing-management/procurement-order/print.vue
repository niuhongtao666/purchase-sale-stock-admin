            ...
            <div class="tableZonePrint">
              <div class="ulPrint" id="ulPrint">
                ...
                <div class="extraInfo" style="line-height:40px;font-size: 14px;display: flex;">
                  <div class="application" style=" text-align: left;flex: 3;">采购单号：{{data.purchaseOrderInfoDTO.purchaseOrderNo}}</div>
                  <div class="store" style="text-align: left;flex: 2;text-indent: -33px;">采购门店：{{data.purchaseOrderInfoDTO.storeName}}</div>
                  <div class="person" style="flex: 2;text-align: right;">采购员：{{data.purchaseOrderInfoDTO.createUserName}}</div>
                </div>
                <div class="extraInfo" style="line-height:40px;font-size: 14px;display: flex;">
                  <div class="application" style=" text-align: left;flex: 3;">采购申请：{{data.purchaseOrderInfoDTO.purchaseDataSource==100?'有':'无'}}</div>
                  <div class="store" style="text-align: left;flex: 2;text-indent: -33px;">供应商：{{data.purchaseOrderInfoDTO.supplierName}}</div>
                  <div class="person" style="flex: 2;text-align: right;">期望到货：{{data.purchaseOrderInfoDTO.expectedArrivalTime | dateFormatToSecond}}</div>
                </div>
                ...
                <div class="tableZone printTable" >
                 <table class="table" cellspacing="0" border  frame=hsides>
                    ...
                    <tr style="text-align: center;height: 55px">
                      ...
                      <th style="min-width:70px">采购数量</th>
                      <th style="min-width:70px">采购单价</th>
                      <th style="min-width:70px">采购总价</th>
                      <th style="min-width:80px">仓库</th>
                    </tr>
                    </thead>
                    <tbody>
