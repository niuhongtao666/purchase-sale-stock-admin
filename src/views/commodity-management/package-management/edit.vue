<template>
  <div>
          ...
          <div class="row-item ">
            ...
            <div class="row">
              <div class="column">
                ...
                <div class="right">
                  <input  :class="['input',isDisabled?'is-disabled':'']" :disabled="isDisabled" type="text" v-model="model.mealsName" placeholder="请输入套餐名称">
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="column">
                ...
                <div class="right">
                  ...
                  <el-select placeholder="请选择" v-model="model.enabled" :class="['el_box',isDisabled?'is-disabled':'']" :disabled="isDisabled" >
                    <el-option
            ...
            <div class="row">
              <div class="column">
                ...
                <div class="right">
                  ...
                  <el-select placeholder="请选择" :class="['el_box',isDisabled?'is-disabled':'']" :disabled="isDisabled" v-model="model.goodsThirdClass">
                    <el-option
            ...
            <div class="row">
              <div class="column">
                ...
                <div class="right">
                  ...
                  <!--<el-select placeholder="请选择" :class="['el_box',userInfo.storeId!=1?'is-disabled':'']" :disabled="userInfo.storeId!=1" v-model="model.commonType">-->
                    <!--<el-option-->
            ...
            <div class="row" style="flex: 2;">
              <div class="column">
                ...
                <div class="right">
                  ...
                  <input :class="['input',isDisabled?'is-disabled':'']" :disabled="isDisabled" type="text" @click="brandTreeShow=true" readonly :value="model.carTypeDesc"
                         placeholder="请选择适用品牌">
    ...
    <div class="item">
      ...
      <div class="item-content ">
        <div class="btn-layout" v-if="(userInfo.storeId==1||userInfo.storeId!=1&&model.commonType===0)&&model.canEdit">
          ...
          <el-table
            ...
            >
              <template slot-scope="scope">
                <input v-model="scope.row.mealsPrice" v-if="userInfo.storeId==1||userInfo.storeId!=1&&model.commonType===0" class="table-ipt-num" type="text">
                <span v-else>
                  {{scope.row.mealsPrice}}
                </span>
              </template>
            </el-table-column>
            <el-table-column
              ...
              label="合计">
              <template slot-scope="scope">
                <span>{{Number((scope.row.unitPrice*scope.row.applyNum).toFixed(2))}}</span>
              </template>
            </el-table-column>
          </el-table>
        </div>
      ...
      <div class="item-content pd54">
        ...
        <div class="table-layout">
          <el-table
            ...
            >
              <template slot-scope="scope">
                <input v-model="scope.row.mealsPrice" class="table-ipt-num" type="text"  v-if="userInfo.storeId==1||userInfo.storeId!=1&&model.commonType===0" >
                <span v-else>{{scope.row.mealsPrice}}</span>
              </template>
            </el-table-column>
            <el-table-column
            ...
            <el-table-column
              ...
              label="总工时">
              <template slot-scope="scope">
                <span>{{Number((scope.row.standardWorkTime*scope.row.applyNum).toFixed(2))}}</span>
              </template>
            </el-table-column>
            <!--<el-table-column-->
              <!--min-width="100"-->
    ...
    <div class="saveZone">
      <div class="saveBtn">
        <button v-if="model.canEdit" type="button" class="btn" @click="validateBeforeSubmit">保存</button>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      ////console.log(this.userInfo.storeId)
    ...
    methods: {
      fetchData() {
        this.$axios.get(`/admin/goods/goodsMealsInfo/detail/${this.model.id}`).then(res => {
