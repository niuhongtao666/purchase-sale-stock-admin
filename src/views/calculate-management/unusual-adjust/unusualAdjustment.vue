        ...
        <div class="select-wrap">
          <div class="group">
            ...
            <div class="group ml0">
              ...
              <div class="right">
                <input type="text" placeholder="请输入调整单号" v-model.trim="model.excepAdjustmentNo">
              </div>
            </div>
            <div class="group ml0">
              <span class="left"></span>
            ...
            <div class="group btn-box ml10">
              ...
              <button type="button" class="btn" @click="toAdd">新增异常调整</button>
            </div>
          </div>
        </div>
      </form>
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <router-link class="linkColor" :to="'/calculate-management/unusual-adjust/detail/'+scope.row.id" target="_blank">
            ...
            >
              <template slot-scope="scope">
                {{scope.row.adjustmentType==1?'异常调整':''}}
              </template>
            </el-table-column>
            <el-table-column
              label="调整分类"
...
<script>
  export default {
    ...
    methods:{
      toAdd(){
        this.$router.push('/calculate-management/unusual-adjust/add');
      },
      initEndTime(date){
      ...
      fetchData(args){
        ...
        this.$axios.post('/admin/stock/stockExceptionAdjustment/list',this.model).then(res=>{
