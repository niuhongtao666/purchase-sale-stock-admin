      ...
      <div class="tab_company_out">
        ...
        <div class="print-content">
          <div class="item-group mb-10">
            <span class="printset ti10">调整单号：{{data.excepAdjustmentNo}}</span>
            <!--<span class="flex1"></span>-->
            <span class="printset ti50">调整类型：{{data.adjustmentType==1?'异常调整':''}}</span>
            <!--<span class="flex1"></span>-->
          ...
          <div class="item mb-10 setCenter table-unset printZone">
            <table class="table" cellspacing="0" >
              ...
              <tr style="text-align: center;">
                ...
                <th class="min195">配件名称</th>
                <th class="min195">生产编码</th>
                <!--<th class="min195">配件品牌</th>-->
                <th class="min45">单位</th>
                <th class="min45">成本单价</th>
                <th class="min45">调整数量</th>
                <th class="min45">调整金额</th>
                <th class="min45">库位</th>
              </tr>
              </thead>
              <tbody>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      pages() {
        var arr=this.data.stockExceptionAdjustmentDetailDTOS;
        var pages_;
      ...
      allData(){
        // for(var i=0;i<25;i++){
        //   this.data.stockExceptionAdjustmentDetailDTOS.push({'goodsNo':1})
        // }
        return this.data.stockExceptionAdjustmentDetailDTOS;
      },
      totalNum(){
        var _this=this;
        var total=0;
